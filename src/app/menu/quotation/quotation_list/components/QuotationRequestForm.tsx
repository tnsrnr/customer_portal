...
import { FileText, MapPin, Calendar, Clock, User, Phone, Upload, Send, Package, AlertCircle, CheckCircle } from 'lucide-react';
...
export default function QuotationRequestForm({ quotationNo, onClose }: QuotationRequestFormProps) {
